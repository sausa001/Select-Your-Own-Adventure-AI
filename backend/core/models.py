...
class StoryOptionLLM(BaseModel):
    ...
    nextNode: Dict[str, Any] = Field(description="The next node content and its options") # Use Dict for nextNode to allow for recursive structure
...
class StoryNodeLLM(BaseModel):
    ...
    options: Optional[List[StoryOptionLLM]] = Field(default=None, description="The options available at this node") # Make options optional for ending nodes
